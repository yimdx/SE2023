<template>
  <div class="all">
    <div class="box">
      ...
      <div class="form">
        <div class="input">
          <el-icon class="myIcon"><User /></el-icon>
          <el-radio-group v-model="radio" size="large" style="font-size:20px">
            <el-radio :label="'buyer'" style="margin-left: 30px" size="large"
              >Common User</el-radio
            >
            <el-radio :label="'seller'" style="margin-left: 20px" size="large"
              >Seller</el-radio
            >
          </el-radio-group>
        </div>
      ...
      <div class="btn">
        <el-button class="btn-c" size="large" round @click="register"><span style="font-size:22px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Create Account&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></el-button>
        <div style="margin:5px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Already have account? <router-link to="/buyer/login">Login</router-link>;</div>
      </div>
    </div>
  </div>
</template>
