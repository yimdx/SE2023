  ...
  <div>
    <el-card>
      <el-descriptions class="margin-top" title="profile" :column="1" border>
          <el-button type="primary" v-if="$route.params.id==$store.state.id" size="small">modify personal information</el-button>
          <el-button @click="showConfirmCodeDialog">modify</el-button>
    ...
    <!-- 修改对话框 -->
    <el-dialog title="modify your personal information" :visible.sync="dialogVisible" center width="20%">
      <div style="display: flex;flex-direction: column;align-items: center;justify-content: center;">
        <el-form :inline="true">
          <el-form-item>
            <el-input v-model="secureCode" placeholder="" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
