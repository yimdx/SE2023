  ...
  <div class="right">
    <div class="tableName">Add Commodity Information :</div>
     <el-table :data="addRecords" :border="true" style="width: 100%;margin-top:0;margin-left:0">
      ...
      <el-table-column label="Operations">
        <template #default="scope">
          <el-button @click="handleAddApprove(scope.$index, scope.row)" class="approve">Approve</el-button>
           <el-button @click="handleAddDisapprove(scope.$index, scope.row)" class="disapprove">Disapprove</el-button>
        </template>
      </el-table-column>
